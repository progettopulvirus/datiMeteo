#' Un tibble con i dati dei parametri meteorologici standardizzati dei punti stazione
#'
#' @description
#' Dati meteo standardizzati associati ai punti stazione. Si tratta dei dati estratti da netCDF delle rianalisi ERA5
#' Il dataset non contiene dati mancanti nei parametri meteoclimatici. Si tratta della versione standardizzata del data frame "meteo".
#' La standardizzazione e' stata effettuata una sola voltaper parametro (tutte le stazioni insieme su tutto il periodo): x-media/sd
...
#'  \item{date}{Data nel formato %Y-%m-%d}
